...
public class TopicRepositoryTest {
  ...
  public void topicRepositoryDeliversTopicsOrdered() {
    ...
    Topic a = new Topic(UUID_BASE + "1", "Javascript für Profis", user, "Eine Kurzbeschreibung.", "Eine" +
            " Langbeschreibung, eine Langbeschreibung.");
    topicRepository.save(a);

    Topic b = new Topic(UUID_BASE + "2", "javascript für Profis", user, "Eine Kurzbeschreibung.", "Eine" +
            " Langbeschreibung, eine Langbeschreibung.");
    topicRepository.save(b);

    Topic c = new Topic(UUID_BASE + "3", "Xxxxxxxxxxxxxxxx", user, "Eine Kurzbeschreibung.", "Eine" +
            " Langbeschreibung, eine Langbeschreibung.");
    topicRepository.save(c);

    Topic d = new Topic(UUID_BASE + "4", "Aaaaaaaaaaaaaaaa", user, "Eine Kurzbeschreibung.", "Eine" +
            " Langbeschreibung, eine Langbeschreibung.");
    topicRepository.save(d);

    Topic e = new Topic(UUID_BASE + "5", "Abaaaaaaaaaaaaaa", user, "Eine Kurzbeschreibung.", "Eine" +
            " Langbeschreibung, eine Langbeschreibung.");
